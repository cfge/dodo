    ...
    <div class="col-10 mx-auto">     
        <div class="row">   <!-- header -->
            ...
            <div class="bsk-box bg-white border rounded col-3 pt-3"> <!-- Корзина -->
             ...
             $query = mysqli_query($con, "SELECT * FROM add");
            ...
            <div class="col-3">   
                ...
                <div class="row">
                    ...
                    <form action="add.php" method="GET">
                        <input name="id" style="display: none" value="<?php echo $stroka["id"] ?>">
                        <input name="name" style="display: none" value="<?php echo $stroka["name"] ?>">
                        <input name="img" style="display: none" value="<?php echo $stroka["img"] ?>">
                        <input name="price" style="display: none" value="<?php echo $stroka["price"] ?>">
